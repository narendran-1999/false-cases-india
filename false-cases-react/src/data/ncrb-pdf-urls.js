...
const pdfUrls = {
    ...
    2017: {
        url: baseUrl + "post/16959893381653885627CrimeinIndia2017-Volume100.pdf",
        pages: pagePattern[1]
    },

    2018: {
        url: baseUrl + "custom/1653734481_Crime%20in%20India%202018%20-%20Volume%201_3_0_0.pdf",
        pages: pagePattern[1]
    },

    2019: {
        url: baseUrl + "custom/1653730573_CII%202019%20Volume%201.pdf",
        pages: pagePattern[1]
    },

    2020: {
        url: baseUrl + "post/16959885631653645869CII2020Volume1.pdf",
        pages: pagePattern[2]
    },

    2021: {
        url: baseUrl + "custom/1696831798CII2021Volume1.pdf",
        pages: pagePattern[3]
    },

    2022: {
        url: baseUrl + "custom/1701607577CrimeinIndia2022Book1.pdf",
        pages: pagePattern[3]
    }
}
