...
const PieImgs = ({isMetro}) => {
  ...
  return (
    <div className="pie-imgs">
        <div className="row">
          <img src={pieArray[0]} className="col-md-6 col-sm-12"/>
          <img src={pieArray[1]} className="col-md-6 col-sm-12"/>
        </div>
        <div className="row">
          <img src={pieArray[2]} className="col-md-6 col-sm-12"/>
          <img src={pieArray[3]} className="col-md-6 col-sm-12"/>
        </div>
    </div>
  )
}
